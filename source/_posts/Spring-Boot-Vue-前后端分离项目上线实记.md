...
![pic_1730b086.png](/images/2025/springboot-vue-project/1.png)

![pic_93189640.png](/images/2025/springboot-vue-project/2.png)

> 第一次购买一般都会有优惠，而且对于一般的单体项目而言 2 核 2G 的配置也够用了，当然也有 3 个月的试用版本。

> 完成之后进入控制台第一件事就是去你左侧边栏的安全组里面开放端口，这样才能从远程访问。

![pic_78a16574.png](/images/2025/springboot-vue-project/3.png)

![pic_ef901e7b.png](/images/2025/springboot-vue-project/4.png)

> 端口范围根据需求开放，一般是 3306 mysql、80 nginx 代理、13103 这里是宝塔面板的端口，什么是宝塔面板后面会讲到，下面 3 个端口是默认初始化好的。

> 然后进入实例面板重新设置一下你的服务器密码：

![pic_607c2eda.png](/images/2025/springboot-vue-project/5.png)

> 修改完成之后就可以试着连接你的服务器了，我这里使用的是 Xshell：

![pic_a2720479.png](/images/2025/springboot-vue-project/6.png)

> 然后输入你刚才重新设置的密码并点击连接：

![pic_38be3af4.png](/images/2025/springboot-vue-project/7.png)

![pic_82b1a136.png](/images/2025/springboot-vue-project/8.png)
...
![pic_b3dc1254.png](/images/2025/springboot-vue-project/9.png)
...
![pic_b3c89e3a.png](/images/2025/springboot-vue-project/10.png)

![pic_b83c902c.png](/images/2025/springboot-vue-project/11.png)

> 如果访问不通就是你没有放行端口，进入阿里云安全组里面去放行对应的端口即可。

> 进入控制面板后直接在右下角的软件商店中安装所需环境：

![pic_25f14775.png](/images/2025/springboot-vue-project/12.png)

> 点开首页就可以清楚的看到我们服务器的整体情况了：

![pic_0dd8d85e.png](/images/2025/springboot-vue-project/13.png)
...
![pic_45a5d47b.png](/images/2025/springboot-vue-project/14.png)

> 然后将可以进行打包部署了，在你父模块（如果是聚合工程的话）的 lifecycle 下先运行 clean 再运行 package 进行打包：

![pic_991cbf5d.png](/images/2025/springboot-vue-project/15.png)
...
![pic_72876713.png](/images/2025/springboot-vue-project/16.png)

![pic_dedc1972.png](/images/2025/springboot-vue-project/17.png)
...
![pic_adfe5b50.png](/images/2025/springboot-vue-project/18.png)
...
![pic_87b54246.png](/images/2025/springboot-vue-project/19.png)
...
![pic_f4902b02.png](/images/2025/springboot-vue-project/20.png)

> 打包完成后会在你项目的第一级目录下生成 dist 文件夹：

![pic_0c1a0aea.png](/images/2025/springboot-vue-project/21.png)

> 然后将这个文件夹上传到服务器，我个人的习惯是和后端 jar 包放在一起：

![pic_2998d1e6.png](/images/2025/springboot-vue-project/22.png)
