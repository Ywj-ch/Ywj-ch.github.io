...
![pic_6c17275f.png](/source/images/微服务入门：服务调用流程解析/1.png)
...
![pic_ee9bc610.png](/source/images/微服务入门：服务调用流程解析/2.png)
...
![pic_e4133fd6.png](/source/images/微服务入门：服务调用流程解析/3.png)
...
[Nacos 快速开始 | Nacos 官网这个快速开始手册是帮忙您快速在您的电脑上，下载、安装并使用 Nacos。https://nacos.io/docs/latest/quickstart/quick-start![pic_6feeb0fa.png](/source/images/微服务入门：服务调用流程解析/4.png)https://nacos.io/docs/latest/quickstart/quick-start][Nacos _ _ Nacos _ Nacos_https_nacos.io_docs_latest_quickstart_quick-start_pic_6feeb0fa.png_https_api.smain.cn_pics_pic_6feeb0fa.png_https_nacos.io_docs_latest_quickstart_quick-start]![pic_e8d7d828.png](/source/images/微服务入门：服务调用流程解析/5.png)

解压到非中文路径下：

![pic_397574c9.png](/source/images/微服务入门：服务调用流程解析/6.png)

![pic_1dbd4962.png](/source/images/微服务入门：服务调用流程解析/7.png)
...
![pic_06de63c9.png](/source/images/微服务入门：服务调用流程解析/8.png)

修改数据库连接默认配置：

![pic_28c31890.png](/source/images/微服务入门：服务调用流程解析/9.png)

![pic_a698e5e1.png](/source/images/微服务入门：服务调用流程解析/10.png)

启动后访问 localhost:8848/nacos ：

![pic_98c3381a.png](/source/images/微服务入门：服务调用流程解析/11.png)
...
![pic_6b15c275.png](/source/images/微服务入门：服务调用流程解析/12.png)
...
![pic_c4a34833.png](/source/images/微服务入门：服务调用流程解析/13.png)

然后新建一个 client 包，里面放访问客户端：

![pic_6c587f75.png](/source/images/微服务入门：服务调用流程解析/14.png)
...
![pic_53b9572b.png](/source/images/微服务入门：服务调用流程解析/15.png)

![pic_aee1db5c.png](/source/images/微服务入门：服务调用流程解析/16.png)
...
![pic_2b9a1a0f.png](/source/images/微服务入门：服务调用流程解析/17.png)

![pic_4b9baabb.png](/source/images/微服务入门：服务调用流程解析/18.png)
...
![pic_1c3d2652.png](/source/images/微服务入门：服务调用流程解析/19.png)
...
![pic_0b08feb6.png](/source/images/微服务入门：服务调用流程解析/20.png)

RabbitMQ 对应的架构如图：

![pic_b98c3ace.png](/source/images/微服务入门：服务调用流程解析/21.png)
...
![pic_62994edd.png](/source/images/微服务入门：服务调用流程解析/22.png)
...
![pic_94df481c.png](/source/images/微服务入门：服务调用流程解析/23.png)
...
![pic_5cf6fee9.png](/source/images/微服务入门：服务调用流程解析/24.png)

整体流程如下图所示：

![pic_4f5eba2e.png](/source/images/微服务入门：服务调用流程解析/25.png)

> 可以看到 `FeignBlockingLoadBalancerClient` 是一个适配器，内部使用了 `LoadBalancerClient` 来实现服务实例的选择和请求的负载均衡处理。

![pic_1e244f9f.png](/source/images/微服务入门：服务调用流程解析/26.png)

我们跟进去发现 `LoadBalancerClient 接口`只有一个实现类就是 BlockingLoadBalancerClient：

![pic_855654a2.png](/source/images/微服务入门：服务调用流程解析/27.png)

其中的 choose 方法实现了负载均衡：

![pic_185d4835.png](/source/images/微服务入门：服务调用流程解析/28.png)

我们继续跟进：

![pic_45dbc134.png](/source/images/微服务入门：服务调用流程解析/29.png)

> ReactiveLoadBalancer 是 Spring-Cloud-Common 组件中定义的负载均衡器接口规范，而 Spring-Cloud-Loadbalancer 组件给出了两个实现：

![pic_a9d3ab98.png](/source/images/微服务入门：服务调用流程解析/30.png)

默认的实现是 RoundRobinLoadBalancer，即轮询负载均衡器。负载均衡器的核心逻辑如下：

![pic_a7f74d43.png](/source/images/微服务入门：服务调用流程解析/31.png)

这里的 ServiceInstanceListSupplier（服务拉取）也有很多实现：

![pic_227eaadd.png](/source/images/微服务入门：服务调用流程解析/32.png)
...
![pic_3f787f7a.png](/source/images/微服务入门：服务调用流程解析/33.png)

#### 3.3.2、NacosRule

> 之前分析源码的时候我们发现负载均衡的算法是有`ReactiveLoadBalancer`来定义的，我们发现它的实现类有三个：

![pic_bb776c1b.png](/source/images/微服务入门：服务调用流程解析/34.png)
...
![pic_f17d0a34.png](/source/images/微服务入门：服务调用流程解析/35.png)

其中定义了默认的负载均衡器：

![pic_3d5b50d2.png](/source/images/微服务入门：服务调用流程解析/36.png)
...
![pic_88dcedb4.png](/source/images/微服务入门：服务调用流程解析/37.png)

> 由于这个 OpenFeignConfig 没有加@Configuration 注解，也就没有被 Spring 加载，因此是不会生效的。接下来，我们要在启动类上通过注解来声明这个配置。

![pic_0c5b3c7c.png](/source/images/微服务入门：服务调用流程解析/38.png)
...
![pic_b1638609.png](/source/images/微服务入门：服务调用流程解析/39.png)
...
![pic_5dcdac23.png](/source/images/微服务入门：服务调用流程解析/40.png)

线程隔离

> 当一个业务接口响应时间长，而且并发高时，就可能耗尽服务器的线程资源，导致服务内的其它接口受到影响。所以我们必须把这种影响降低，或者缩减影响的范围。线程隔离正是解决这个问题的好办法。

![pic_7a459a49.png](/source/images/微服务入门：服务调用流程解析/41.png)

服务熔断

> 线程隔离虽然避免了雪崩问题，但故障服务依然会拖慢服务调用方的接口响应速度，这个时候就需要进行熔断以拒绝调用该接口。

![pic_3f36eb3c.png](/source/images/微服务入门：服务调用流程解析/42.png)
...
![pic_74b39e89.png](/source/images/微服务入门：服务调用流程解析/44.png)

访问[http://localhost:8090][http_localhost_8090]页面，就可以看到 sentinel 的控制台了：

需要输入账号和密码，默认都是：sentinel

![pic_4fbc2f32.png](/source/images/微服务入门：服务调用流程解析/45.png)
...
![pic_1681c221.png](/source/images/微服务入门：服务调用流程解析/46.png)

#### 3.4.3、请求限流

直接在 sentinel 设置就行：

![pic_6b3f9dfd.png](/source/images/微服务入门：服务调用流程解析/47.png)

![pic_ec3ef67d.png](/source/images/微服务入门：服务调用流程解析/48.png)

#### 3.4.4、线程隔离

![pic_e9f1eede.png](/source/images/微服务入门：服务调用流程解析/49.png)

> 总的处理能力等于并发线程数乘上单机 QPS

![pic_daf71bfb.png](/source/images/微服务入门：服务调用流程解析/50.png)

#### 3.4.5、服务熔断

![pic_31fb73f1.png](/source/images/微服务入门：服务调用流程解析/51.png)

![pic_f33fbd76.png](/source/images/微服务入门：服务调用流程解析/52.png)
...
[Seata 是什么？ | Apache Seatahttps://seata.apache.org/zh-cn/docs/overview/what-is-seata/![pic_f30f1de4.png](/source/images/微服务入门：服务调用流程解析/53.png)https://seata.apache.org/zh-cn/docs/overview/what-is-seata/][Seata _ _ Apache Seatahttps_seata.apache.org_zh-cn_docs_overview_what-is-seata_pic_f30f1de4.png_https_api.smain.cn_pics_pic_f30f1de4.png_https_seata.apache.org_zh-cn_docs_overview_what-is-seata]
...
![pic_e60aa4cf.png](/source/images/微服务入门：服务调用流程解析/54.png)
...
![pic_d07a654e.png](/source/images/微服务入门：服务调用流程解析/55.png)
...
![pic_e6d9217e.png](/source/images/微服务入门：服务调用流程解析/56.png)
...
![pic_94cbcb7b.png](/source/images/微服务入门：服务调用流程解析/57.png)
...
![pic_b8633d02.png](/source/images/微服务入门：服务调用流程解析/58.png)
...
![pic_14547a3b.png](/source/images/微服务入门：服务调用流程解析/59.png)

![pic_b350093e.png](/source/images/微服务入门：服务调用流程解析/60.png)
...
![pic_88be4dac.png](/source/images/微服务入门：服务调用流程解析/64.png)
...
![pic_1f74dbeb.png](/source/images/微服务入门：服务调用流程解析/65.png)

![pic_8725c95f.png](/source/images/微服务入门：服务调用流程解析/66.png)
